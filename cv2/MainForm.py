...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionMinimum_Area_Enclosing_Rectangle.triggered.connect(self.maerClick)
    ...
    def input(self):
        ...
        # Call function to setting path with specific Canvas parameters
        self.Canvas.setPath(width, height)

    # Minimal Area Enclosing Rectangle function calling
    def maerClick(self):
        pol = self.Canvas.getPolygon()
        self.Canvas.clearResPol()
        a = Algorithms()
        for polygons in pol:
            res = a.minAreaEnclosingRectangle(polygons)
            self.Canvas.getResPol(res)
            self.Canvas.repaint()

    # Wall Average function calling
    def waClick(self):
        pol = self.Canvas.getPolygon()
        self.Canvas.clearResPol()
        a = Algorithms()
